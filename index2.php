...
$response = $client->request('GET', 'https://api.themoviedb.org/3/trending/tv/day?language=en-US', [
  'headers' => [
...
<div style="position: absolute; top: 10px; right: 10px;">
    ...
    <div class="search-bar">
        ...
        <form method="GET" action="search2.php">
            <input type="text" name="query" placeholder="Search for a webseries or anime..." required>
...
const previousUrl3 = document.referrer;
